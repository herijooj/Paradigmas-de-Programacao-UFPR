...
public class Board {
    ...
    public void setRestrictedSectors() {
        ...
        // CUIDAR SE MAIS DE UM PONTO FOR GERADO NA MESMA POSICAO -- amaral
        for (int i = 0; i < restrictedSectorsCount; i++) {
            // randomnly generate two numbers between 0 and 8
            int iCoordinate = (int) (Math.random() * 9); // -- Isso tava com 10, gerava de 0 a 9, mudei pra 9 -- amaral
            int jCoordinate = (int) (Math.random() * 9);
